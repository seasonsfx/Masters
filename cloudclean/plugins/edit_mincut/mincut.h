...
public:
    ...
    */
    void
    setForegroundPoints (typename pcl::PointCloud<pcl::PointXYZI>::Ptr foreground_points);
    ...
    */
    void
    setBackgroundPoints (typename pcl::PointCloud<pcl::PointXYZI>::Ptr background_points);
