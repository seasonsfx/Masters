...
MinCutStoer::MinCutStoer(CloudModel * cm, int source_layer_idx, int dest_layer_idx)
{
...
void MinCutStoer::createGraph(int k, pcl::PointXYZI & clickPoint){
