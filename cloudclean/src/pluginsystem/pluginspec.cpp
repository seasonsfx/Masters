...
/*!
    ...
    See also IPlugin for more information about plugin dependencies and
    version matching.
*/
...
/*!
    \fn uint qHash(const PluginDependency &value)
    \internal
*/
...
{
    return provides(pluginName, version);
}
